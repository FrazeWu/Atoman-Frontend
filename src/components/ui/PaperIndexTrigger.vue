...
.paper-index-trigger.is-right .trigger-label {
...
.paper-index-trigger.is-right .trigger-tape {
  position: absolute;
  right: -1px;
  top: 15%;
  bottom: 15%;
...
.paper-index-trigger.is-right:hover {
  transform: translate(-4px, -50%);
  box-shadow: -10px 10px 30px rgba(0, 0, 0, 0.2);
}

.paper-index-trigger.is-right.is-active {
...
.paper-index-trigger.is-right.is-active .trigger-label {
  color: var(--a-color-ink);
}

.paper-index-trigger.is-right:hover .trigger-label,
.paper-index-trigger.is-right.is-active .trigger-label {
  opacity: 1;
}

/* Top/Inline Position (for header use) */
.paper-index-trigger.is-top {
  padding: 0.5rem 1rem;
...
.paper-index-trigger.is-top:hover {
