...
const relatedArticles = computed<TimelineItem[]>(() => items.value.map((item) => ({
  type: 'feed_item',
  feed_item: item as unknown as FeedItem,
...
const openArticleSheet = (item: StarredFeedItem, index?: number, replaceRoute = false) => {
