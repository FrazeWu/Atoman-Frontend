...
import { IconArrowLeft as ArrowLeft, IconArrowRight as ArrowRight, IconCircleCheck as CheckCircle2, IconHeadphones as Headphones, IconUpload as Upload } from '@tabler/icons-vue'
