<template>
  ...
  >
    <div v-if="collabPeers.length > 0 && effectiveMode === 'split'" class="a-editor-presence">
    ...
    <div v-if="showToolbar && effectiveMode === 'split'" class="a-editor-toolbar">
      <div class="tb-row">
    ...
    <div
      class="a-editor-body"
      :class="[effectiveMode === 'split' ? 'a-editor-sv-body' : 'a-editor-normal-body', { dragging: isDragging }]"
...
.a-editor-normal-body.dragging::after {
  content: '松开鼠标上传图片';
  position: absolute;
  inset: 0;
...
.a-editor-normal-body .cm-container {
  min-height: 10rem;
}
