  ...
  return {
    ...
    v1: {
      ...
      forum: {
        ...
        resolveReport: (id: string) => `${apiUrl}/forum/moderation/reports/${id}/resolve`,
        userActions: `${apiUrl}/forum/moderation/user-actions`,
        applyUserAction: (id: string) => `${apiUrl}/forum/moderation/users/${id}/actions`,
        moderationUsers: `${apiUrl}/forum/moderation/users`,
		groups: `${apiUrl}/forum/groups`,
		group: (id: string) => `${apiUrl}/forum/groups/${id}`,
		groupMember: (groupId: string, userId: string) => `${apiUrl}/forum/groups/${groupId}/members/${userId}`,
		categoryPermissions: `${apiUrl}/forum/category-permissions`,
		categoryPermission: (id: string) => `${apiUrl}/forum/category-permissions/${id}`,
      },
    },
    music: {
    ...
    interactions: {
      ...
      videoComments: (videoId: number | string) => `${apiUrl}/discussions/video/${videoId}/comments`,
      videoComment: (commentId: number | string) => `${apiUrl}/comments/${commentId}`,
    },
