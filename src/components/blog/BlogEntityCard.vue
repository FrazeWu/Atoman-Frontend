...
.blog-entity-card:hover,
.blog-entity-card:focus-visible {
...
.blog-entity-card:hover .blog-entity-card__subscribe,
.blog-entity-card:focus-within .blog-entity-card__subscribe {
  opacity: 1;
  pointer-events: auto;
}
