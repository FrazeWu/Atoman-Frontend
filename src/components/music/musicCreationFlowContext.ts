...
export const musicCreationFlowKey: InjectionKey<ComputedRef<MusicCreationFlowState | null>> = Symbol('music-creation-flow')

export function useMusicCreationFlow(fallback: ComputedRef<MusicCreationFlowState | null>) {
