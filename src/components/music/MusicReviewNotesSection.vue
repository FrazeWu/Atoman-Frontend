<template>
  <ASurface class="music-review-notes" tone="soft" :layer="0">
    ...
    <ATextarea :model-value="notes.editNote" label="编辑摘要" placeholder="简要说明本次改动" :rows="3" @update:model-value="(value) => updateNotes('editNote', value)" />
    <ATextarea :model-value="notes.reviewNote" label="审核理由" placeholder="为什么这次提交应被接受" :rows="4" @update:model-value="(value) => updateNotes('reviewNote', value)" />
  </ASurface>
</template>
