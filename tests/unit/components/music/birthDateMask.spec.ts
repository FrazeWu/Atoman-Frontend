...
describe('birthDateMask', () => {
  it('formats partial digits with yyyy/mm/dd placeholders', () => {
	...
	it('parses and serializes uncertain dates', () => {
		...
		expect(parsePartialDateParts('2015/7-/--')).toEqual({ year: '2015', month: '7', day: '--' })
		expect(parsePartialDateParts('2015/07/2-')).toEqual({ year: '2015', month: '07', day: '2' })
		...
		expect(serializePartialDate({ year: '2024', month: '02', day: '29' })).toBe('2024-02-29')
