...
describe('resolveLyricsSelection', () => {
  it('从连续歌词 DOM Range 返回跨行起止位置', () => {
    ...
    root.innerHTML = [
      '<div data-lyric-line-key="line-1"><p class="music-lyrics-line__text">first line</p></div>',
      '<div data-lyric-line-key="line-2"><p class="music-lyrics-line__text">second line</p></div>',
    ].join('')
