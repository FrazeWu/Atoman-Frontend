...
.paper-entry.is-read .feed-entry-title {
...
.paper-entry.is-open .feed-entry-title {
...
.paper-entry:hover .feed-entry-actions,
.paper-entry.force-show-actions .feed-entry-actions {
  opacity: 1;
  pointer-events: auto;
}

.paper-entry.is-open .feed-entry-actions {
