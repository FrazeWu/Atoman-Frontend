...
<style scoped>
.moderation-panel,.moderation-panel__list,.moderation-panel__item{display:grid;gap:1rem}.moderation-panel__toolbar,.moderation-panel__item header,.moderation-panel__resolve{display:flex;align-items:center;gap:.75rem;justify-content:space-between}.moderation-panel__item{padding:1rem 0;border-bottom:1px solid var(--a-color-line)}.moderation-panel__item p{margin:0}.moderation-panel__resolve{justify-content:flex-start;flex-wrap:wrap}.moderation-panel__resolve input,.moderation-panel__toolbar select{min-height:2.75rem;border:1px solid var(--a-color-line);background:var(--a-color-surface);color:var(--a-color-ink);padding:.5rem}.moderation-panel__resolve input{flex:1;min-width:12rem}.moderation-panel__error{color:var(--a-color-danger)}.moderation-panel__empty{color:var(--a-color-ink-muted)}time{color:var(--a-color-ink-muted);font-size:.875rem}
</style>
